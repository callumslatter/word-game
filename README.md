...
# Other stretch goals (As suggested by callumslatter)

There are further changes which could be made to imrpove this game

- Congratulatory magic when you win the game
- Sad magic when you lose the game
- Changing the winning Banner to a modal 
- Changing nature of the game that your score is based on your speed